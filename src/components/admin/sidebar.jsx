...
const Sidebar = () => {
    ...
    const handleLogout = async () => {
        try {
            const response = await fetch('https://e-commerce-backend-im60.onrender.com/admin/logout', {
                method: 'POST',
                headers: {
    ...
    const handleSubmit = async () => {
        try {
            const response = await fetch('https://e-commerce-backend-im60.onrender.com/create-product', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
